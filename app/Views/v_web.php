  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="http://localhost/sistemlogin_ci4/public/web">Home</a></li>
          ...
          <li class="drop-down"><a href="#pengadopsi">Pengadopsi</a>
            <ul>
              <li><a href="#paket">Paket Adopsi</a></li>
            </ul>
          </li>
  ...
  <main id="main">
    ...
    <section id="donatur" class="donatur section-bg">
      ...
      <style>
        ...
        /* ---- Responsive flip-card untuk tablet----- */
        @media (max-width: 769px) {
          ...
          /* ---- Responsive flipcard untuk Tablet ----- */
          .get-started-btn,
          .scrollto {
            margin-right: 20px;
          }
        ...
        /* ---- Responsive flipcard untuk smartphone ----- */
        @media(max-width: 535px) {
          .card-deck {
            margin-left: 70px;
          }

          /* ---- Responsive Testimoni smartphone ---- */
          .card-deck,
          .card,
          .shadow img {
            justify-content: center;
          ...
          /* --- Responsive Tombol login pada smartphone ---*/
          .get-started-btn,
          .scrollto {
            margin-right: 40px;
            margin-bottom: 50px;
          ...
          /* ---- Responsive Untuk Tulisan Logo PT Agrowisata Porlak Parna pada Header pada smartphone --- */
          #header .logo,
          .mr-auto {
            font-size: 20px;
            margin-bottom: 50px;
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="card-deck">
            <div class="flip-card">
              <div class="flip-card-inner">
                <div class="flip-card-front">
                  <h5 style="font-family: 'Times New Roman', Times, serif; margin-top:150px">PAKET ADOPSI A</h5>
                </div>
                <div class="flip-card-back">
                  <img src="<?= base_url() ?>/template/a/assets/img/paket.png" style=" border-radius : 30px; width: 298px; height: 190px; margin-bottom: -100px;">
            ...
            <div class="flip-card">
              ...
              <div class="flip-card-inner">
                <div class="flip-card-front">
                  <h5 style="font-family: 'Times New Roman', Times, serif; margin-top:150px">PAKET ADOPSI B</h5>
                </div>
            ...
            <div class="flip-card">
              <div class="flip-card-inner">
                <div class="flip-card-front">
                  <h5 style="font-family: 'Times New Roman', Times, serif; margin-top:150px">PAKET ADOPSI C</h5>
                </div>
            ...
            <div class="column">
              <div class="card-deck">
                <div class=" flip-card">
                  <div class="flip-card-inner">
                    <div class="flip-card-front">
                      <h5 style="font-family: 'Times New Roman', Times, serif; margin-top:150px">PAKET ADOPSI D</h5>
                    </div>
                ...
                <div class="flip-card">
                  <div class="flip-card-inner">
                    <div class="flip-card-front">
                      <h5 style="font-family: 'Times New Roman', Times, serif; margin-top:150px">PAKET ADOPSI E</h5>
                    </div>
